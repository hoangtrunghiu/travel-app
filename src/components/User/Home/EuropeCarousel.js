...
const EuropeCarousel = () => {
   ...
   return (
      <Background image="/images/background/background-hoaanhdao-scaled.jpg">
         <h2 className={clsx(styles.title, 'text-center mx-8')}>Điểm Đến Đẹp Nhất Mùa Xuân Châu Âu 2025</h2>
      ...
      //       <img
      //          src="/images/background/background-hoaanhdao-scaled.jpg"
      //          alt="background"
      ...
      //    <h2 className={clsx(styles.title, 'text-center')}>Điểm Đến Đẹp Nhất Mùa Xuân Châu Âu 2025</h2>
      //    <div className={styles.carouselContainer}>
      //       <Carousel ref={carouselRef} dots={false} slidesToShow={slidesToShow} slidesToScroll={1} infinite draggable>
      //          {data.map((item) => (
      //             <div key={item.id} className={styles.carouselItem}>
